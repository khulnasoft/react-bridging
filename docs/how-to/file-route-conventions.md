...
The `@react-bridging/fs-routes` package enables file-convention based route config.

## Setting up

First install the `@react-bridging/fs-routes` package:

```shellscript nonumber
npm i @react-bridging/fs-routes
```
