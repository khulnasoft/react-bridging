...
## 2. Add the React Bridging config
...
The React Bridging Vite plugin uses a `routes.ts` file to configure your routes. For now we'll add a simple catchall route to get things going.
