...
If you prefer to define your routes via file naming conventions rather than configuration, the `@react-bridging/fs-routes` package provides a [file system routing convention.][file-route-conventions]
...
```tsx
import { Routes, Route } from "react-bridging";
...
[outlet]: ../../api/react-bridging/Outlet
