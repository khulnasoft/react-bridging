...
# Contributing to React Bridging
...
- All new features, bug-fixes, or **anything that touches `react-bridging` code** should be branched off of and merged into the `dev` branch
...
1. Fork the repo (click the <kbd>Fork</kbd> button at the top right of [this page](https://github.com/khulnasoft/react-bridging))
2. Clone your fork locally

```bash
# in a terminal, cd to parent directory where you want your clone to be, then
git clone https://github.com/<your_github_username>/react-bridging.git
cd react-bridging
...
3. Install dependencies and build. React Bridging uses [pnpm](https://pnpm.io), so you should too. If you install using `npm`, unnecessary `package-lock.json` files will be generated.
...
Please provide thoughtful comments and some sample code that show what you'd like to do with React Bridging in your app. It helps the conversation if you can show us how you're limited by the current API first before jumping to a conclusion about what needs to be changed and/or added.
...
React Bridging uses a monorepo to host code for multiple packages. These packages live in the `packages` directory.
...
# Test only react-bridging-dom
pnpm test --projects packages/react-bridging-dom
```
