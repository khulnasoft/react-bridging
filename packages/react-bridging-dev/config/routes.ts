...
declare global {
  var __reactBridgingAppDirectory: string;
}

export function setAppDirectory(directory: string) {
  globalThis.__reactBridgingAppDirectory = directory;
}
...
export function getAppDirectory() {
  invariant(globalThis.__reactBridgingAppDirectory);
  return globalThis.__reactBridgingAppDirectory;
}
