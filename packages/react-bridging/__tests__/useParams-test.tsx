...
import { MemoryRouter, Outlet, Routes, Route, useParams } from "react-bridging";
...
describe("useParams", () => {
  ...
  describe("when the path has some params", () => {
    it("returns an object of the URL params", () => {
      ...
      TestRenderer.act(() => {
        renderer = TestRenderer.create(
          <MemoryRouter initialEntries={["/blog/react-bridging"]}>
            <Routes>
    ...
    describe("a child route", () => {
      it("returns a combined hash of the parent and child params", () => {
        ...
        TestRenderer.act(() => {
          renderer = TestRenderer.create(
            <MemoryRouter
              initialEntries={["/users/mjackson/courses/react-bridging"]}
            >
              <Routes>
        ...
        expect(renderer.toJSON()).toMatchInlineSnapshot(`
          <div>
            ...
            <pre>
              {"username":"mjackson","course":"react-bridging"}
            </pre>
          </div>
        `);
      });
