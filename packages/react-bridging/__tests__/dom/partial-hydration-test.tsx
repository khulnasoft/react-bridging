...
import {
  Outlet,
  RouterProvider as ReactBridging_RouterProvider,
  createBrowserRouter,
  createHashRouter,
  createMemoryRouter,
  useLoaderData,
...
import { RouterProvider as ReactBridgingDom_RouterProvider } from "../../dom-export";
...
describe("Partial Hydration Behavior", () => {
  describe("createBrowserRouter", () => {
    testPartialHydration(createBrowserRouter, ReactBridgingDom_RouterProvider);
  });

  describe("createHashRouter", () => {
    testPartialHydration(createHashRouter, ReactBridgingDom_RouterProvider);
  });

  describe("createMemoryRouter", () => {
    testPartialHydration(createMemoryRouter, ReactBridging_RouterProvider);
    ...
    it("supports partial hydration w/patchRoutesOnNavigation (leaf fallback)", async () => {
      ...
      let { container } = render(
        ...
        <ReactBridging_RouterProvider router={router} />
      );
...
function testPartialHydration(
  ...
  RouterProvider:
    | typeof ReactBridgingDom_RouterProvider
    | typeof ReactBridging_RouterProvider
) {
