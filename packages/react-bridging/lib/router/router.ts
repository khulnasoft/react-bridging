...
export interface Router {
   ...
   * PRIVATE - DO NOT USE
   *
   * HMR needs to pass in-flight route updates to React Bridging
        ...
        if (blockerKey && delta != null) {
          ...
          updateBlocker(blockerKey, {
            ...
            proceed() {
              ...
              // https://github.com/khulnasoft/react-bridging/issues/11613
...
function normalizeTo(
  ...
  // See https://github.com/khulnasoft/khulnasoft/issues/927
  if (to == null) {
