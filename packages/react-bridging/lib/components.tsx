    ...
    (
      ...
      warnOnce(
        ...
        "You provided the `flushSync` option to a router update, " +
          "but you are not using the `<RouterProvider>` from `react-bridging/dom` " +
          "so `ReactDOM.flushSync()` is unavailable.  Please update your app " +
          'to `import { RouterProvider } from "react-bridging/dom"` and ensure ' +
...
export interface AwaitProps<Resolve> {
  ...
  */
  ...
  ```jsx
  import { useLoaderData, Await } from "react-bridging"
