...
type SSRInfo = {
  context: NonNullable<(typeof window)["__reactBridgingContext"]>;
...
function initSsrInfo(): void {
  if (
    !ssrInfo &&
    window.__reactBridgingContext &&
    window.__reactBridgingManifest &&
    window.__reactBridgingRouteModules
  ) {
    ssrInfo = {
      context: window.__reactBridgingContext,
      manifest: window.__reactBridgingManifest,
      routeModules: window.__reactBridgingRouteModules,
...
function createHydratedRouter(): DataRouter {
  ...
  if (!ssrInfo.context.isSpaMode) {
    ...
    let initialMatches = matchRoutes(
      routes,
      window.location,
      window.__reactBridgingContext?.basename
    );
    if (initialMatches) {
  ...
  window.__reactBridgingDataRouter = router;
...
export function HydratedRouter() {
  ...
  if (process.env.NODE_ENV === "development") {
    if (ssrInfo) {
      window.__reactBridgingClearCriticalCss = () => setCriticalCss(undefined);
    }
  }
