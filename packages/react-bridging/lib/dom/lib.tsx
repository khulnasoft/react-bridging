...
// the rollup config.
//
// Export a global property onto the window for React Bridging detection by the
...
function deserializeErrors(
  ...
  for (let [key, val] of entries) {
    ...
    // serializeErrors in react-bridging-dom/server.tsx :)
 ...
 * version of the history library that React Bridging uses internally.
 *
...
Because it uses the HTML form API, server rendered pages are interactive at a basic level before JavaScript loads. Instead of React Bridging managing the submission, the browser manages the submission as well as the pending states (like the spinning favicon). After JavaScript loads, React Bridging takes over enabling web application user experiences.
...
/**
  ...
  ```tsx
  import { ScrollRestoration } from "react-bridging";
...
/**
  ...
  ```tsx
  import { useSearchParams } from "react-bridging";
...
/**
  ...
  ```tsx
  import { useFormAction } from "react-bridging";
...
/**
  ...
  ```tsx
  import { useFetchers } from "react-bridging";
...
const SCROLL_RESTORATION_STORAGE_KEY = "react-bridging-scroll-positions";
