  ...
  let scriptTag = value ? (
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: `window.__reactBridgingContext.streamController.enqueue(${escapeHtml(
    ...
    return (
      <>
        ...
        <script
          nonce={nonce}
          dangerouslySetInnerHTML={{
            __html: `window.__reactBridgingContext.streamController.close();`,
          }}
        />
      </>
    );
...
async function singleFetchLoaderNavigationStrategy(
  ...
  if (
    ...
    !window.__reactBridgingHdrActive
  ) {
