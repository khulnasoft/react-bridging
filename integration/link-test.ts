...
test.describe("route module link export", () => {
    ...
    fixture = await createFixture({
      files: {
        ...
        "app/routes/links.tsx": js`
          import { useLoaderData, Link } from "react-bridging";
        ...
        "app/routes/gists.tsx": js`
          import { data, Link, Outlet, useLoaderData, useNavigation } from "react-bridging";
        ...
        "app/routes/gists.$username.tsx": js`
          import { data, redirect } from "react-bridging";
          import { Link, useLoaderData, useParams } from "react-bridging";
  ...
  test.describe("script imports", () => {
    ...
    test("are added to the document", async ({ page }) => {
      ...
      expect(await scripts[0].innerText()).toContain("__reactBridgingContext");
