    ...
    fixture = await createFixture(
      {
        files: {
          ...
          "app/routes/_index.tsx": js`
              import { Link, Form } from "react-bridging";
          ...
          "app/routes/action.child-error.tsx": js`
              import { Form, useLoaderData, useRouteError } from "react-bridging";
...
test.describe("Default ErrorBoundary", () => {
  ...
  function getFiles({
    ...
    return {
      "app/root.tsx": js`
          import { Links, Meta, Outlet, Scripts, useRouteError } from "react-bridging";
