...
let files = {
  ...
  "app/root.tsx": js`
    ...
    import { Form, Link, Links, Meta, Outlet, Scripts, useRouteError } from "react-bridging";
      ...
      files: {
        ...
        "app/routes/about.tsx": js`
          ...
          export function loader({ request }) {
            return "ABOUT-" + request.headers.has('X-React-Bridging-Prerender');
          }
        ...
        "app/routes/not-prerendered.tsx": js`
          import { useLoaderData } from 'react-bridging';
          export function loader({ request }) {
            return "NOT-PRERENDERED-" + request.headers.has('X-React-Bridging-Prerender');
          }
    ...
    fixture = await createFixture({
      ...
      files: {
        ...
        "app/routes/about.tsx": js`
          ...
          export function loader({ request }) {
            return {
              prerendered: request.headers.has('X-React-Bridging-Prerender') ? 'yes' : 'no',
              // 24999 characters
