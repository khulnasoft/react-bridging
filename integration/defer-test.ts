  ...
  test.beforeAll(async () => {
    fixture = await createFixture({
      files: {
        ...
        `,
        "app/root.tsx": js`
          import { Links, Meta, Outlet, Scripts, useLoaderData } from "react-bridging";
        ...
        "app/routes/_index.tsx": js`
          import { Link, useLoaderData } from "react-bridging";
          import Counter from "~/components/counter";
        ...
        "app/routes/deferred-noscript-resolved.tsx": js`
          ...
          import { Await, Link, useLoaderData } from "react-bridging";
          import Counter from "~/components/counter";
