    ...
    fixture = await createFixture({
      files: {
        "app/routes/get-submission.tsx": js`
          import { useLoaderData, Form } from "react-bridging";
        ...
        "app/routes/blog.tsx": js`
          import { Form, Outlet } from "react-bridging";
          export default function() {
            return (
              <>
                <h1>Blog</h1>
        ...
        "app/routes/form-method.tsx": js`
          import { Form, useActionData, useLoaderData, useSearchParams } from "react-bridging";
        ...
        "app/routes/file-upload.tsx": js`
          import { Form, useSearchParams } from "react-bridging";
        ...
        "app/routes/outputFormData.tsx": js`
          import { useActionData, useSearchParams } from "react-bridging";
        ...
        "app/routes/pathless-layout-parent.tsx": js`
          import { Form, Outlet, useActionData } from "react-bridging"
