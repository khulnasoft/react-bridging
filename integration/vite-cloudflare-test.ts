...
const files: Files = async ({ port }) => ({
  ...
  `,
  "load-context.ts": `
    import { type AppLoadContext } from "@react-bridging/cloudflare";
    ...
    declare module "@react-bridging/cloudflare" {
  ...
  `,
  "functions/[[page]].ts": `
    import { createPagesFunctionHandler } from "@react-bridging/cloudflare";

    // @ts-ignore - the server build file is generated by \`react-bridging build\`
