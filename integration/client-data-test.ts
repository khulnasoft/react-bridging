...
import { UNSAFE_ServerMode as ServerMode } from "react-bridging";
import {
  createAppFixture,
  createFixture,
  js,
...
function getFiles({
  ...
  return {
    "app/root.tsx": js`
      import { Outlet, Scripts } from "react-bridging"
    ...
    "app/routes/parent.child.tsx": js`
      import { Form, Outlet, useActionData, useLoaderData } from "react-bridging"
      export function loader() {
      ...
      let fixture = await createFixture({
        files: {
          ...
          "app/routes/parent.child.tsx": js`
            ...
            import { json } from "react-bridging"
            import { Await, useLoaderData } from "react-bridging"
            export function loader() {
              return {
      ...
      appFixture = await createAppFixture(
        await createFixture({
          files: {
            ...
            "app/routes/parent.child.tsx": js`
              import * as React from 'react';
              import { useLoaderData, useRouteError } from "react-bridging";
              export async function clientLoader({ serverLoader }) {
      ...
      appFixture = await createAppFixture(
        await createFixture({
          files: {
            ...
            "app/routes/parent.child.tsx": js`
              import * as React from 'react';
              import { useLoaderData, useRevalidator } from "react-bridging";
        ...
        await createFixture(
          {
            files: {
              ...
              "app/routes/parent.child.tsx": js`
                import { ClientLoaderFunctionArgs, useRouteError } from "react-bridging";
        ...
        await createFixture(
          {
            files: {
              ...
              "app/routes/parent.tsx": js`
                import { Outlet, useLoaderData, useRouteLoaderData, useRouteError } from 'react-bridging'
                export function loader() {
                  return { message: 'Parent Server Loader' };
                }
                export async function clientLoader({ serverLoader }) {
              ...
              `,
              "app/routes/parent.child.tsx": js`
                import { useRouteError, useLoaderData } from 'react-bridging'
                export function loader() {
        ...
        await createFixture({
          files: {
            ...
            "app/routes/parent.child.tsx": js`
              import * as React from 'react';
              import { json } from "react-bridging";
              import { Form, useRouteError } from "react-bridging";
              export async function clientAction({ serverAction }) {
